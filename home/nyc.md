...
## Understanding NANDA and the Agentic Web
...
#### The Early Promise of the Internet
When the Internet first emerged, it carried an incredible promise: open communication, free exchange of ideas, and democratized access to knowledge.

#### The Centralization Problem
Over time, that openness began to narrow:
- A small number of companies began to control much of the world's information flow
- Algorithms optimized for engagement created echo chambers and fueled polarization
- Design patterns that kept people scrolling contributed to growing mental health issues

**NANDA exists to avoid repeating those same mistakes as we transition into the next digital era.**

### The Agentic Web: The Next Internet

The Agentic Web represents a shift from human-operated systems to networks where AI agents act on our behalf. Imagine:

- A student's AI assistant coordinating with a professor's agent to schedule meetings
...
Students are uniquely positioned to drive this movement:

- **Curiosity:** Young minds question assumptions, an essential trait for redesigning global systems
- **Diversity:** Youth bring perspectives from across cultures and disciplines, ensuring the Agentic Web reflects global needs
- **Technical fluency:** Today's students are digital natives who understand both the potential and dangers of technology
- **Personal relevance:** The youth of today will be the most impacted demographic by the formation of the Agentic Web

By joining NANDA, ambassadors become part of a movement to shape the policies, standards, and technologies that will govern AI agents for decades to come.

---

## Research & Discussion Tracks

NANDA research is organized into three broad tracks that guide ambassador activities:

### Track 1: Policy / STS (Science, Technology, and Society)

**Focus:** How social systems, governance, and values evolve with the rise of agentic technologies.
...
**Example Questions:**
- How might agentic systems change the relationship between citizens and institutions?
- What ethical frameworks best support human agency in AI-mediated decision-making?
- How should governments balance innovation and regulation in the Agentic Web?

**Suggested Activities:**
- Host panels on "AI Policy for the Agentic Era"
- Lead workshops on AI ethics case studies
- Organize debates on the governance of decentralized systems

### Track 2: Technical / Infrastructure

**Focus:** The underlying architectures, models, and frameworks that power agentic systems and ensure they operate safely and transparently.
...
**Example Questions:**
- How can explainability be achieved without sacrificing performance?
- What frameworks ensure multi-agent coordination remains aligned with human goals?
- How can open-source collaboration accelerate the safety of agentic models?
...
**Focus:** Imagining and shaping the societal, cultural, and creative dimensions of the Agentic Web.
...
**Example Questions:**
- What would a "humane" Agentic Web look like?
- Can agents become collaborators in art, science, or education rather than replacements?
- How do we preserve human meaning and identity in an increasingly automated digital world?

**Suggested Activities:**
- Organize art-tech showcases or creative agentic collaborations
- Host community discussions on "The Future of the Web as a Living System"
- Publish reflections or zines exploring speculative futures of human-agent coexistence

---

## Event Guidelines

### Purpose of NANDA Events

NANDA events are designed to foster dialogue, exploration, and collaboration around the ideas of the Agentic Web. Events should always reflect NANDA's values:
...
1. Submit a short proposal to your NANDA coordinator outlining the event's theme, goals, and estimated attendance
2. Confirm alignment with NANDA's mission and code of conduct
3. **Avoid using the MIT or MIT Media Lab logos or branding.** When referencing the project, use "NANDA Student Ambassador Program" or "Project NANDA"
4. Budget responsibly and keep clear records of all expenses

### Inclusivity and Respect

Guidelines for conduct:
- Foster inclusive participation
- Be mindful of cultural and accessibility needs
- Handle disagreements constructively
- Avoid political or commercial endorsements

**Remember:** You are a facilitator of dialogue, not an arbiter of truth.

### Event Documentation

After each event, please submit:
- Event name and date
- Location or platform
- Number of attendees (approximate)
- Audience type
- Main topics or insights discussed
- Photos or materials (with consent)

### Event Ideas

- **Discussion Circles:** Small group discussions on digital identity, explainable AI, or ethics
- **Workshops:** Interactive sessions teaching participants to prototype agentic systems
- **Community Showcases:** Students present creative interpretations of digital agency
- **Cross-disciplinary Panels:** Conversations between technologists, ethicists, and artists

### Safety, Privacy, and Consent

- Protect participant privacy
- Comply with local school/university policies
- Avoid collecting personal data unless necessary
- Ensure all participants feel welcome and safe
...
**AI Square Studio:** A platform for turning static knowledge (documents, slide decks, videos, FAQs) into interactive, searchable, and conversational learning experiences.

**How ambassadors can use it:**
- Event augmentation: Convert workshop materials into interactive AI Studios
- Demonstrations and prototypes: Build lightweight conversational demos
- Learning companions: Publish curated knowledge bases as ongoing resources

### Event Resources

- Official NANDA Branding Kit
- Ambassador Handbook and Quick Reference Sheets
- Metrics Tracker Template
- Event Planning Checklist

### Resource Request Process

Ambassadors can request additional resources through the **NANDA Support Form**, including:
- Funding assistance for approved events
- Access to specialized AI tools
- Mentorship from NANDA-affiliated researchers
- Guidance on event design

### Technology Ethics and Use

All technological use under NANDA must adhere to:
- **Transparency:** Clearly communicate what technologies are being demonstrated
- **Consent:** Obtain permission before using personal data or recordings
- **Safety:** Do not deploy untested AI systems
- **Explainability:** Explain reasoning, limitations, and data sources
...
Exceptional ambassadors may join faculty-led or cross-institutional NANDA projects focusing on agentic systems, web governance, or AI ethics.

#### 2. Publications and Presentations
Ambassadors can publish reflections, essays, or project findings in NANDA's official blog or contribute to future reports.

### Advancing Ambassador Status

Ambassadors who demonstrate consistent engagement, leadership, and reflection will be eligible for:
- Senior Ambassador Recognition
- Opportunities to mentor new ambassadors
- Invitations to co-author white papers or participate in working groups

**Renewal based on:**
- Event engagement and reporting
- Collaboration with peers and mentors
- Demonstrated understanding of NANDA's mission
...
As a representative of NSAP, you're expected to:

- Be respectful, inclusive, and uphold NANDA's commitment to ethical AI
- Follow campus rules for events and engagement
- Collaborate, not compete, with other campus organizers
...
**The Agentic Web is the next Internet. NANDA is its foundation. You are its architects.**
