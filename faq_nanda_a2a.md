...
## Will there be confusion about Project Nanda's role after the A2A announcement?

Yes, initially there may be confusion as developers understand the relationship. However, NANDA is complementary with broader scope - providing decentralized infrastructure that works with and enhances standardized protocols like A2A, rather than competing with them.

## Is A2A a separate non-profit organization?

No. A2A is a project within the Linux Foundation driven by a volunteer Technical Steering Committee. Members provide guidance for the protocol syntax, but there are no separate working groups or research roadmaps beyond the core communication specification. For example, other communication protocols such as MCP or NLweb are not part of this Linux Foundation project.